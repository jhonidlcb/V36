                                        ...
                                        onClick={async () => {
                                          try {
                                            ...
                                            if (response.ok) {
                                              ...
                                              // Si es un archivo de imagen, mostrarlo en un modal
                                              if (contentType?.startsWith('image/')) {
                                                ...
                                                modal.innerHTML = `
                                                  <div class="bg-white rounded-lg max-w-4xl w-full max-h-[90vh] overflow-hidden">
                                                    <div class="flex justify-between items-center p-4 border-b">
                                                      ...
                                                      <button class="close-modal text-gray-400 hover:text-gray-600 text-2xl font-bold leading-none">&times;</button>
                                                    </div>
                                                    <div class="p-4 overflow-auto max-h-[calc(90vh-120px)]">
                                                      <img src="${imageUrl}" alt="Comprobante" class="w-full h-auto rounded-lg shadow-lg" />
                                                    </div>
                                                    <div class="p-4 border-t flex justify-between items-center">
                                                      <p class="text-sm text-gray-600">Etapa: ${stage.stageName}</p>
                                                ...
                                                // Si es JSON (info del archivo), mostrar info
                                                const data = await response.json();
                                                toast({
                                                  title: "Información del comprobante",
                                                  description: `Archivo: ${data.fileName} (${(data.fileSize / 1024 / 1024).toFixed(2)} MB)`,
                                                });
                                              }
                                            } else {
